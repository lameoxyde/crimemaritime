...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée disponible",sInfo:"Afficher _START_ jusqu'à _END_ de total est _TOTAL_ ",sInfoEmpty:"Afficher 0 jusqu'à  0 de total est 0 ",
